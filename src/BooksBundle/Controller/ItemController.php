...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $items = $em->getRepository('BooksBundle:Item')->findAll();
    ...
    {
        $item = new Item();
        $form = $this->createForm('BooksBundle\Form\ItemType', $item);
    ...
    {
        $deleteForm = $this->createDeleteForm($item);
        $editForm = $this->createForm('BooksBundle\Form\ItemType', $item);
